...
CREATE TABLE `xhs_authers` (
  `auther_user_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '作者唯一标识',
  `auther_home_page_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者主页 URL',
  `auther_avatar` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者头像 URL',
  `auther_nick_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者昵称',
  `auther_desc` text COLLATE utf8mb4_general_ci COMMENT '作者简介',
  `auther_interaction` int unsigned DEFAULT '0' COMMENT '互动数',
  `auther_ip_location` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者所在地',
  `auther_red_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '红书 ID',
  ...
  `auther_gender` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者性别',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '记录更新时间',
...
CREATE TABLE `xhs_comment_at_users` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `comment_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '关联的评论ID，关联 xhs_comments(comment_id)',
  `at_user_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '被@的用户ID',
  `at_user_nickname` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '被@的用户昵称',
  `at_user_home_page_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '被@用户主页 URL',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `xhs_comments` (
  `comment_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '评论唯一标识',
  `note_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '所属笔记ID，关联 xhs_notes 或 xhs_note_details',
  `parent_comment_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '父评论ID，顶级评论为 NULL，子评论存储其顶级评论的 comment_id',
  `comment_user_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '评论者用户ID',
  `comment_user_image` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论者头像 URL',
  `comment_user_nickname` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论者昵称',
  `comment_user_home_page_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论者主页 URL',
  `comment_content` text COLLATE utf8mb4_general_ci COMMENT '评论内容',
  ...
  `comment_sub_comment_cursor` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '子评论分页游标（如接口返回）',
...
CREATE TABLE `xhs_keyword_group_notes` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `group_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '关键词群ID，关联 xhs_keyword_groups(group_id)',
  `note_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '笔记ID，关联 xhs_notes(note_id)',
  `retrieved_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '该笔记被采集的时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_group_note` (`group_id`,`note_id`),
  KEY `idx_note_id` (`note_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3910 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='关键词群与笔记关联关系表，用于记录某个关键词群查询到的帖子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xhs_keyword_groups` (
  ...
  `group_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '关键词群名称或描述',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='关键词群表，用于存储关键词群信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xhs_note_details` (
  `note_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '笔记唯一标识，与 xhs_notes 对应',
  `note_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '笔记详情页面 URL',
  `note_last_update_time` datetime DEFAULT NULL COMMENT '笔记最后更新时间',
  `note_create_time` datetime DEFAULT NULL COMMENT '笔记创建时间',
  `note_model_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记模型类型',
  `note_card_type` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记卡片类型',
  `note_display_title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记展示标题',
  `note_desc` text COLLATE utf8mb4_general_ci COMMENT '笔记描述内容（包含话题及文本描述）',
  ...
  `video_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频标识（如存在）',
  `video_h266_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频 H266 URL',
  `video_a1_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频 a1 URL',
  `video_h264_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频 H264 URL',
  `video_h265_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '视频 H265 URL',
  ...
  `auther_user_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '作者唯一标识，关联 xhs_authers 表',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '记录更新时间',
  PRIMARY KEY (`note_id`),
...
CREATE TABLE `xhs_notes` (
  `note_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '笔记唯一标识',
  `note_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '笔记详情页面 URL',
  `note_xsec_token` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记鉴权 token',
  `note_cover_url_pre` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记封面预览图 URL',
  `note_cover_url_default` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '笔记默认封面图 URL',
  ...
  `auther_user_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '作者唯一标识，关联 xhs_authers 表',
  `auther_home_page_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者主页 URL（冗余字段）',
  `auther_avatar` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者头像 URL（冗余字段）',
  `auther_nick_name` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '作者昵称（冗余字段）',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '记录创建时间',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '记录更新时间',
  PRIMARY KEY (`note_id`),
  KEY `idx_auther_user_id` (`auther_user_id`)
...
CREATE TABLE `xhs_topic_discussions` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `topic_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '话题名称',
  `topic_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '话题类型，例如 official',
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='小红书话题讨论量记录表，每日记录话题的讨论量';
/*!40101 SET character_set_client = @saved_cs_client */;
